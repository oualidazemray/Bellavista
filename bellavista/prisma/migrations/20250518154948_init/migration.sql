...
-- AddForeignKey
ALTER TABLE "SeasonalPricing" ADD CONSTRAINT "SeasonalPricing_hotelInfoId_fkey" FOREIGN KEY ("hotelInfoId") REFERENCES "HotelInfo"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
